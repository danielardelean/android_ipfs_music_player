...
public class ListAdapter extends ArrayAdapter<Song> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView firstTextView = convertView.findViewById(R.id.item_list_name_textview);
        firstTextView.setText(getItem(position).getmName());

        TextView title = convertView.findViewById(R.id.item_list_title_textview);
        ...
        convertView.findViewById(R.id.list_item).setOnClickListener(view -> {
            ...
            args.putSerializable("ARRAYLIST", allSongsArrayList);
