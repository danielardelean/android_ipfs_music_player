...
import com.example.textile.list_fragment.AlbumFragment;
import com.example.textile.list_fragment.ArtistFragment;
import com.example.textile.list_fragment.GenreFragment;
import com.example.textile.list_fragment.PlaylistFragment;
...
//        });
        ...
        tabLayout.getTabAt(2).setIcon(R.drawable.ic_view_agenda_black_24dp);
        tabLayout.getTabAt(3).setIcon(R.drawable.ic_playlist_play_black_24dp);
